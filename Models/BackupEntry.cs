...
public class BackupRegistryValue
{
    ...
    public string  ValueDataDisplay { get; set; } = "";
    public string  ValueType { get; set; } = "DWORD";
    public bool    WasAbsent { get; set; } = false;
}

/// <summary>項目単位の適用前スナップショット</summary>
public class BackupItemSnapshot
{
    public string ItemId            { get; set; } = "";
    public string ItemName          { get; set; } = "";
    public string Category          { get; set; } = "";
    public bool   WasEnabledBefore  { get; set; }
    public bool   WillBeEnabled     { get; set; }
    public int    RegistryEntryCount { get; set; }
}
...
public class BackupSession
{
    ...
    public List<BackupItemSnapshot>  Items       { get; set; } = [];
}
